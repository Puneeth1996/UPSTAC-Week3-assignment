...
public class ConsultationController {
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            // replace this line of code with your implementation
            User userDoctor = userLoggedInService.getLoggedInUser(); // getting currently logged in doctor
            return testRequestUpdateService.assignForConsultation(id,userDoctor); // assigning the given test
            //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            // replace this line of code with your implementation
            User userDoctor = userLoggedInService.getLoggedInUser(); // getting currently logged in doctor
            return testRequestUpdateService.updateConsultation(id,testResult,userDoctor);// updating the given
            //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
